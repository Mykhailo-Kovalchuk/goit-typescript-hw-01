"use strict";
// розгортання (Ініціалізація) проєкту та встановлення серверу
// ініціалізуємо проєкт через npm:         npm init -y
//  Тепер встановимо сам сервер:  npm i --save-dev @web/dev-server
//   Потім можна запускати    npm start
//   команда для віслідковування змін в проєкті:   tsc -w
